...
- **Metodisk kjeldevurdering:** Kjelde-matrisa er no oppdatert i seks sentrale innlegg (Trump-blokkade, Ungarn-valet, Andrew Hugg-lekkasjen, FMA-korrupsjon, Renteauke, Oljefondet). Ved kvar ny kjelde, gjer ein aktiv vurdering av Kvalitet (A-D) og Habilitet (1-3) basert på skalaen i `CLAUDE.md`. Deklarer dette alltid i kjelde-lista.
